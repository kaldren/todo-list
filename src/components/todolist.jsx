...
class TodoList extends Component {
  ...
  handleClickSave = (item, e) => {
    ...
    const key = items.indexOf(item);
    items[key] = e;
    this.setState({ items, cssEditInput: "displayNone" }, () => {
  ...
  componentDidMount() {
    this.storageArray = Object.values(localStorage);
    this.setState({ items: this.storageArray });
  }
